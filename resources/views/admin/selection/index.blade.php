...
@section('ajaxCalls')
    <script>
        ...
        showData('{{route('selections.index')}}', columns);
        // Delete Using Ajax
        destroyScript('{{route('selections.destroy',':id')}}');
        // Add Using Ajax
        showAddModal('{{route('selections.create')}}');
        addScript();
        // Add Using Ajax
        showEditModal('{{route('selections.edit',':id')}}');
        editScript();
    </script>
