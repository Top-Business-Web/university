...
<head>
    ...
    <link href="{{ asset('/uploads/university_setting/'.$setting->logo) }}" rel="icon" />
    <!-- bootstrap -->
                    ...
                    <div class="p-5">
                        <div class="row">
                            ...
                            <div class="image-logo1 right_section_1 col-6">
                                <img src="{{ asset('/uploads/university_setting/'.$setting->logo) }}" />
                            </div>
                            <!--end right_section_1 -->
                        </div>
                        <!-- End Row -->
                        ...
                        <div class="row">
                            <div class="col-2  d-flex justify-content-center">
                                <img src="{{ asset('uploads/users/'.$user->image) }}"
                                     alt="{{ $user->first_name }}" style="width: 140px; height: 120px" class="img-fluid" />
                            </div>
                            <div class="col-8">
                                <table class="table">
                                    <tbody>
...
{{--                            @endforeach--}}
                        ...
                        <div class="d-flex justify-content-end">
                            <div>
                                <img style="width: 145px;" src="{{ asset('/uploads/university_setting/'.$setting->stamp_logo) }}">
                            </div>
                        </div>
