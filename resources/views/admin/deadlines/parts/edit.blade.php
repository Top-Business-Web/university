        ...
        <div class="row">
            ...
            <div class="col-md-12 col-12">
                ...
                <select name="deadline_type" class="form-control">
                    <option value="">@lang('admin.select')</option>
                    <option value="0" style="text-align: center" {{ $deadline->deadline_type == 0 ? 'selected' : '' }}>{{trans('deadline.process_exam')}}</option>
                    <option value="1" style="text-align: center" {{ $deadline->deadline_type == 1 ? 'selected' : '' }}>{{trans('deadline.process_degree')}}</option>
